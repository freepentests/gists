...
The process I just showed you is not complicated. In fact, it's so simple that there are even sites dedicated to automating the process of deobfuscating this shit: https://obf-io.deobfuscate.io/. What's the point of obfuscating your code when someone can just go to deobfuscate.io and get back the original code instantly? It does absolutely nothing but increase the size of your JavaScript file.
